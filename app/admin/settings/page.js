...
export default function AdminSettings() {
  ...
  const fetchStatus = async () => {
    try {
      const res = await fetch("https://ripple-flask-server.pxxl.pro/admin/settings/api/admin/settings/status", {
  ...
  const toggleMaintenance = async () => {
    ...
    try {
      ...
      const res = await fetch("https://ripple-flask-server.pxxl.pro/admin/settings/api/admin/settings/toggle", {
        method: "POST",
        headers: {
