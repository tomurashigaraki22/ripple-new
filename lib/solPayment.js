import {
  ...
  export const sendSolanaPayment = async (wallet, amount, connection, type = "xrpb-sol", shippingFee = 0) => {
    try {
      ...
      if (type === "solana") {
        ...
        if (currentBalance < amount) {
          throw new Error(`❌ Insufficient XRPB-SOL balance. Required: ${amount}, Available: ${currentBalance}`);
        }
