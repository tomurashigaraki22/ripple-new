 ...
 */
export const sendXRPLXRPBPayment = async (wallet, destinationAddress, amount, currency, issuer, shippingFee = 0) => {
    try {
      if (!wallet || !wallet.account) {
        throw new Error("XRPL Wallet not connected (XRPLXRPB)");
      }
